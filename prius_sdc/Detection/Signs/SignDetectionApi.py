...
def detect_Signs(frame,frame_draw):
    ...
    if not model_loaded:
        ...
        # model = load_model(os.path.abspath("data/saved_model_Ros2_5_Sign.h5"),compile=False)

        model = load_model("/home/luqman/ros2_workspace/src/prius_sdc/prius_sdc/data/saved_model_Ros2_5_Sign.h5")
